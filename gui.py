...
from gui.workflow_controller import WorkflowController
...
class FocustGUI(QWidget):
    ...
    def open_workflow_tools_page(self):
        ...
        return self.workflow_controller.open_workflow_tools_page()
    ...
    def workflow_export_classification_dataset(self):
        ...
        return self.workflow_controller.workflow_export_classification_dataset()

    def workflow_run_binary_training(self):
        return self.workflow_controller.workflow_run_binary_training()

    def workflow_run_multiclass_training(self):
        return self.workflow_controller.workflow_run_multiclass_training()

    def workflow_browse_eval_dataset(self):
        return self.workflow_controller.workflow_browse_eval_dataset()

    def workflow_browse_detect_folder(self):
        return self.workflow_controller.workflow_browse_detect_folder()

    def _workflow_selected_engine(self) -> str:
        return self.workflow_controller._workflow_selected_engine()

    def _workflow_preflight_engine(self, engine: str) -> bool:
        return self.workflow_controller._workflow_preflight_engine(engine)

    def workflow_load_eval_dataset(self, *, auto_run: bool):
        return self.workflow_controller.workflow_load_eval_dataset(auto_run=auto_run)

    def workflow_load_detect_folder(self, *, auto_run: bool):
        return self.workflow_controller.workflow_load_detect_folder(auto_run=auto_run)
